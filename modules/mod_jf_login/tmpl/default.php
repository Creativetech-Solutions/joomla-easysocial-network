		...
		<div class="jf_modal jf_modal_effect_1">
			<div class="jf_modal_content">
				...
				<div>
					...
					<div class="jf_modal_close" data-toggle="tooltip" data-placement="left" title="<?php echo JText::_('MOD_JF_LOGIN_CLOSE'); ?>">×</div>
				</div>
			</div>
		</div>
		<div class="jf_modal_overlay"></div>
		<button class="jf_modal_trigger" data-toggle="tooltip" data-placement="bottom" title="<?php echo JText::_('MOD_JF_LOGIN_MY_ACCOUNT'); ?>"><i class="fa fa-user"></i></button>
	<?php else : ?>
		<div class="jf_modal jf_modal_effect_1">
			<div class="jf_modal_content">
							...
							: ?>
								<div class="jf_register">
									...
									<?php if ($jf_login_register_link_url == '') { ?>
										<a class="jf_register_link" href="<?php echo JRoute::_('index.php?Itemid='.$jf_login_register_link_menu); ?>">
											<?php echo JText::_('MOD_JF_LOGIN_SIGN_UP_NOW'); ?>
										</a>
									<?php } else { ?>
										<a class="jf_register_link" href="<?php echo $jf_login_register_link_url; ?>">
											<?php echo JText::_('MOD_JF_LOGIN_SIGN_UP_NOW'); ?>
										</a>
									<?php } ?>
									<i class="fa fa-arrow-right"></i>
		...
		<div class="jf_modal_overlay"></div>
		<button class="jf_modal_trigger" data-toggle="tooltip" data-placement="bottom" title="<?php echo JText::_('MOD_JF_LOGIN_ACCOUNT'); ?>"><i class="fa fa-lock"></i></button>
	<?php endif; ?>
</div>