...
JLoader::register("CrowdfundingUserProjectsModuleHelper", JPATH_ROOT . "/modules/mod_crowdfundinguserprojects/helper.php");
...
// Get projects.
$projects = CrowdfundingUserProjectsModuleHelper::getProjects($userId, $limitResults);
if (!$projects) {
    return;
}
...
// Display user social profile ( integration ).
