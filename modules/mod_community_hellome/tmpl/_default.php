...
<div class="joms-module--hellome">
    ...
    <div class="joms-hcard">
        ...
        <p>
            ...
            <?php echo $userdata->city.', '.$userdata->state_name.', '.$userdata->country_name;?>
        </p>
        <p>
            <?php if($userdata->weburl !=''){ ?>
                <i aria-hidden="true" class="fa fa-bookmark"></i>  <?php echo $userdata->weburl;?>
            <?php } ?>
        </p>
        <p>
        ...
        <?php 
        	if($userdata->skillFirstHire==1 || $userdata->skillSecondHire==1 || $skillThirdHire->skillSecondHire==1 ){
        ?>
