...
jQuery(document).ready( function() {
  if( /Android|webOS|iPhone|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) 
    {
    	jQuery('#modulehellome').addClass( 'moduleextracls' );
   }
} );
...
<div class="joms-module--hellome <?php if($page == "newsfeed"){ echo "hidemodclass"; }?> " id="modulehellome" >
    ...
    <div  class="joms-hcard ">
            ...
            //echo '<pre>';print_r($userdata);exit;
                if($userdata->memberType !=0)
                {
                    ...
                    {   
                        ...
                        if($skillname)
                         echo $skillname;
                        if($userdata->specialityFirst != '')
                            echo '('.$userdata->specialityFirst.')';
                        echo '</p>';
                    }
                    if($userdata->skillSecond != '')
                    {
                        ...
                        if($userdata->specialitySecond != '')
                            echo '('.$userdata->specialitySecond.')';
                        echo '</p>';
                    }
                    if($userdata->skillThird != '')
                    {
                        ...
                        if($userdata->specialityThird != '')
                            echo '('.$userdata->specialityThird.')';
                        echo '</p>';
                    }
                }
           ?>   
            ...
            <?php if($userdata->weburl !=''){ ?>
                ...
                <a target="_blank" href="<?php echo JRoute::_('"'.$userdata->weburl.'"');?>"><?php echo substr($userdata->weburl,0,20).'...';?></a>
            <?php } ?>
        </p>
        <p>
        ...
        <?php 
            if($userdata->skillFirstTeach==1 || $userdata->skillSecondTeach==1 || $userdata->skillThirdTeach==1 ){
        ?>
        <p style="color:red;"><img src='<?php echo $url1;?>images/teach.png'/> <?php echo JText::_('MOD_HELLOME_I_TEACH_LESSONS'); ?></p>
