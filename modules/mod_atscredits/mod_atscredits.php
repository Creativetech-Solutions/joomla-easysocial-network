...
$showCredits = $params->get('showCredits', 1);
$showTime    = $params->get('showTime', 0);

if ($showCredits)
{
	@include JModuleHelper::getLayoutPath('mod_atscredits', $layout . '_credits');
}

if ($showTime)
{
	@include JModuleHelper::getLayoutPath('mod_atscredits', $layout . '_time');
}