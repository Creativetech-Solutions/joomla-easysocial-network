    ...
    <?php if (!empty($projects)) { ?>
        <div class="row">
            <?php foreach ($projects as $project) {
                ...
                $image = CrowdfundingUserPledgesModuleHelper::getImage($params->get("image_type", "square"), $project, $componentParams, $imagesDirectory);
                ...
                <div class="col-md-<?php echo $itemSpan; ?>">
                    ...
                    <div class="thumbnail cf-usrplgh-project">
                        <?php if (!empty($image)) { ?>
                        ...
                        <?php if ($displayInfo) { ?>
                        <div class="cf-usrplgh-caption-info absolute-bottom">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="text-uppercase"><?php echo JText::_("MOD_CROWDFUNDINGUSERPLEDGES_FUNDED"); ?></div>
                                </div>
                                <div class="col-md-4">
                                    <div class="bolder"><?php echo $raised; ?></div>
                                    <div class="text-uppercase"><?php echo JText::_("MOD_CROWDFUNDINGUSERPLEDGES_RAISED"); ?></div>
                                </div>
                                <div class="col-md-4">
                                    <div class="bolder"><?php echo $daysLeft; ?></div>
                                    <div class="text-uppercase"><?php echo JText::_("MOD_CROWDFUNDINGUSERPLEDGES_DAYS_LEFT"); ?></div>
                                </div>
                            </div>
                            <?php } ?>
                        </div>
