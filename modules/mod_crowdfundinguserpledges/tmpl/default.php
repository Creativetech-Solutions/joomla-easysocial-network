            ...
            <div>
                ...
                <div class="<?php echo $projectClass; ?>">
                    ...
                    <?php if ($displayInfo) { ?>
                        ...
                        <p class="font-xxsmall"><?php echo JText::sprintf("MOD_CROWDFUNDINGUSERPLEDGES_GOAL", $amount->setValue($project["goal"])->formatCurrency(), $amount->setValue($project["funded"])->formatCurrency()); ?></p>
                    <?php } ?>
                </div>
