    ...
    if ($comments) {
        ...
        foreach ($comments as $comment) {
            ...
            if (($char_limit > 0) && (JString::strlen($comment->comment) > $char_limit)) {
                $comment->comment = JString::substr(CUserHelper::replaceAliasURL($comment->comment,false,true), 0, $char_limit) . '...';
            }
            ...
            <div class="joms-stream__header no-gap">
                ...
                <div class="joms-avatar--stream <?php echo ($params->get('show_image', 2) == 1) ? CUserHelper::onlineIndicator(CFactory::getUser($comment->post_by)) : 'square'; ?> ">
                    <a href="<?php echo ($params->get('show_image',2) == 1) ? '' : $link; ?>" >
                ...
                <div class="joms-stream__meta">
                    ...
                    <a href="<?php echo CRoute::_('index.php?option=com_community&view=profiles&userid='.$comment->post_by) ?>"><?php echo CFactory::getUser($comment->post_by)->getDisplayName(); ?></a>
