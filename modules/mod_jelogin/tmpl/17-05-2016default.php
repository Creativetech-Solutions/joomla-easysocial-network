	                	...
	                	<div class="choice_separator"><span><?php echo JText::_('JOR'); ?></span></div>
	                   		<ul class="login_uls">
			                    <li>
			                       ...
			                       <input id="modlgn_username" placeholder="<?php echo JText::_('COM_JOOMPROJECT_USERNAME_PLACEHOLDER'); ?>" type="text" name="username" class="full-width has-padding has-border" alt="username" style="width: 140px;" autocomplete="off" /> 
						 		</li>
			                    <li>
