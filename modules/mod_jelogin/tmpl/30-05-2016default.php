...
$userpic = mod_jeloginHelper::getUserPic($user->id);
	...
	<div class="allicontopprofle">
   			...
   			<li class="user_profile_pic">
   				<a href="javascript:void(0);" onclick="profatch1();">
		            ...
		            <?php 
			            if($userpic!='')
			            { 
			              if(file_exists(JPATH_ROOT.'/images/watermarks/'.$userpic))
			              {
			                 $userpic=$userpic;
			              }
			              else 
			              {
			              	$userpic='default-user.png';
			              }
			            }
			            else 
			           	{
		            ...
		            ?>
           			 <img class="fa-user" src="<?php echo $image_path_user.$userpic; ?>" alt="<?php echo $user->name; ?>" /><label> <?php echo $user->name; ?></label>
           		</a>
           	</li>
        </ul>
	    ...
	    <div class="profilediv" id="prodash11" style="display:none;">
	    	...
	    	<ul class="user_profile_ul">
                ...
                <li><a href="#"><i aria-hidden="true" class="fa fa-envelope">&nbsp;</i> Messages</a></li>
