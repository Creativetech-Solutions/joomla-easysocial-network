...
>
	...
	<div class="col-xs-12 data" data-content>
		<?php 
                echo $this->includeTemplate( $subNamespace ); 
                if($field->element == 'birthday'){
                    echo '<span class="birthday-help"><i class="fa fa-question" aria-hidden="true"></i></span>';
                }
                ?>
	</div>
	...
	<?php if( $params->get( 'display_description' ) ) {
		echo $this->includeTemplate( 'site/fields/description',array('field' => $field) );
	} ?>
</div>
