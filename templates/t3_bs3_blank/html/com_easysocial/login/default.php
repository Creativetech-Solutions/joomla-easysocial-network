...
?>
<div class="es-login-box es-responsive" data-guest-login>
    <div class="row">
        <div class="dowalo-header">
            <img src="<?php echo JURI::base() ?>images/template/logo_lg.png" />
        </div>
        <div class="col-md-6">
            <div>
...
<!--					<div class="login-box-title"><?php echo JText::_('COM_EASYSOCIAL_LOGIN_TO_ACCOUNT_TITLE'); ?></div>-->
                    <fieldset class="mt-20">
                        ...
                        <button type="submit" class="btn btn-es-success btn-block mt-20 btn-login">
    ...
    <!--                            <p class="line">
                    ...
                    <div class="text-center forgot-password">
                        <?php if ($this->config->get('registrations.emailasusername')) { ?>
                            <a class="text-error a" href="<?php echo FRoute::account(array('layout' => 'forgetPassword')); ?>"> <?php echo JText::_('COM_EASYSOCIAL_LOGIN_FORGOT_PASSWORD_FULL'); ?></a>
                        <?php } else { ?>
                            <a class="text-error bv" href="<?php echo FRoute::account(array('layout' => 'forgetUsername')); ?>"> <?php echo JText::_('COM_EASYSOCIAL_LOGIN_FORGOT_USERNAME'); ?></a> /
                            <a class="text-error v" href="<?php echo FRoute::account(array('layout' => 'forgetPassword')); ?>"> <?php echo JText::_('COM_EASYSOCIAL_LOGIN_FORGOT_PASSWORD'); ?></a>
                        <?php } ?>
                    </div>
        ...
        <!--                            <p class="text-center mb-20">
                            ...
                            if ($this->config->get('oauth.facebook.registration.enabled') && $this->config->get('registrations.enabled') && (
                                ...
                                ?>
                                <?php /* ?><div class="text-center es-signin-social">
                                  <p class="line">
                ...
                <div class="col-md-6 register-column simple-register">
                    <div class="register-wrap">
                        <div class="login-box-title">
                            ...
                            <a class="" href="<?php echo FRoute::registration(); ?>"><?php echo JText::_('COM_EASYSOCIAL_LOGIN_REGISTER_NOW_BUTTON'); ?></a>
                        </div>
        <!--                        <p class="text-center mb-20">
                        <?php echo JText::_('COM_EASYSOCIAL_LOGIN_REGISTER_NOW'); ?>
                        </p>-->
        ...
        <?php } ?>
                <div class="col-md-6">
                    <p><?php echo  JText::_('COM_EASYSOCIAL_LOGIN_TERMS_POLICY'); ?></p>
                </div>
