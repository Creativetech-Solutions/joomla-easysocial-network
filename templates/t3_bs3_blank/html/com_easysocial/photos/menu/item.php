...
<div data-photo-menu class="es-media-item-menu es-photo-menu-item">
	...
	<div class="btn-group btn-group-xs">
		<div class="es-media-item-menu-item btn dropdown_" data-item-actions-menu>
			<a href="javascript: void(0);" data-bs-toggle="dropdown" class="photo-edit-btn">
				<!--<i class="fa fa-cog"></i>-->
			</a>
			<ul class="dropdown-menu">
                ...
                <li data-photo-feature-button class="<?php echo ($photo->featured) ? 'featured' : ''; ?>">
                    <a href="javascript: void(0);"><?php echo $photo->featured ? JText::_("COM_EASYSOCIAL_PHOTOS_UNFEATURE_PHOTO"): JText::_("COM_EASYSOCIAL_PHOTOS_FEATURE_PHOTO"); ?></a>
                </li>
                <?php } ?>

				<?php if ($this->config->get('photos.original')) { ?>
				<?php /*?><li data-photo-original-button>
