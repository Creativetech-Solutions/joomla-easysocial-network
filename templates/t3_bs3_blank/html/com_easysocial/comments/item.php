...
?>
<li class="es-comment" data-comments-item data-id="<?php echo $comment->id; ?>" data-child="<?php echo $comment->child; ?>">
    <div class="media">
            ...
            <div data-comments-item-commentFrame data-comments-item-frame>
                ...
                <div class="es-comment-actions " data-comments-item-actions>
                    <div class="es-comment-actions-flyout">
                        ...
                        <?php
                        if ($this->my->id && ($this->access->allowed('comments.report') || ($this->access->allowed('comments.edit') || ($isAuthor && $this->access->allowed('comments.editown'))) || ($deleteable || $this->access->allowed('comments.delete') || ($isAuthor && $this->access->allowed('comments.deleteown'))))) {
                            ?>
                ...
                <div class="es-comment-item-meta" data-comments-item-meta>
                    <div class="inline-block <?php echo $likes->hasLiked() ? "active" : "" ?>">
                        <div class="es-comment-item-like" data-comments-item-like>
                            <a href="javascript:void(0);"></a>
                        </div>
                        <div data-comments-item-likeCount class="inline-block like-count numcount" data-original-title="<?php echo strip_tags($likes->toString(null, true)); ?>" data-placement="top" data-es-provide="tooltip"><?php echo $likes->getCount(); ?></div>

                    </div>
                    
                    <div class="btn-comment-delete inline-block" data-comments-item-actions-delete>
