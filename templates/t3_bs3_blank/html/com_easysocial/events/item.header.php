...
<div class="es-profile-header"
    ...
    <div class="es-event-header-body fd-cf">
        <div>
        ...
        <div class="es-profile-header-action pull-right">
            ...
            <?php if ($this->my->isSiteAdmin() || $guest->isOwner() || $guest->isAdmin()) { ?>
                <div class="dropdown_">
                    ...
                    <ul class="dropdown-menu dropdown-menu-user messageDropDown" data-event-extras data-id="<?php echo $event->id; ?>">
                        ...
                        <?php if (($event->isAdmin() || $event->isOwner()) && $event->featured == false) { ?>
                            <li>
                                <a href="javascript:void(0);" data-event-feature><?php echo JText::_('APP_AUDIOS_FEATURE_BUTTON');?></a>
                            </li>
                        <?php } ?>

                        <?php if (($event->isAdmin() || $event->isOwner()) && $event->featured == true) { ?>
                            <li>
            ...
            <?php } else { ?>
                <div class="dropdown_">
                    ...
                    <ul class="dropdown-menu dropdown-menu-user userOpdropdown">
