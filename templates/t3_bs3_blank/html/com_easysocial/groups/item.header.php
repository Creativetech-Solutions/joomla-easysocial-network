...
<div class="es-profile-header"
        ...
        <?php if ($this->my->isSiteAdmin() || $group->isOwner() || $group->isAdmin()) { ?>
            <div class="dropdown_">
                <a class="btn btn-block btn-es-primary btn-sm" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <i class="fa fa-cog mr-5"></i><span><?php echo JText::_('COM_EASYSOCIAL_GROUPS_MANAGE_GROUP'); ?></span><i class="fa fa-caret-down"></i>
                </a>
    ...
    <div class="es-profile-header-footer">
        <nav class="es-list-vertical-divider pull-left">
            ...
            <?php /*?><?php if ($this->config->get('video.enabled', true) && $group->getParams()->get('videos', true) && $group->getCategory()->getAcl()->get('videos.create', true)) { ?>
                <span>
            ...
            <?php /*?><?php if ($this->config->get('photos.enabled', true) && $group->getCategory()->getAcl()->get('photos.enabled', true) && $group->getParams()->get('photo.albums', true)) { ?>
                <span>
            ...
            <?php echo $this->render('widgets', 'group', 'groups', 'groupHeaderFooter', array($group)); ?>
