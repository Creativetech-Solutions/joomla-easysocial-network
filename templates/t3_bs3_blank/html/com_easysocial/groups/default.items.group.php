...
<div class="es-profile-header ed-profile-header--group-list-item">
    ...
    <div class="es-profile-header-heading  with-cover">
        ...
        <div class="es-profile-header-avatar es-flyout " data-profile-avatar="">
            <a href="<?php echo $group->getPermalink();?>" class="es-avatar">
    ...
    <div class="es-profile-header-body fd-cf">
        <div>
            <div class="media-body">
                ...
                <nav class="es-list-vertical-divider">
                    <?php if( $group->isOpen() ){ ?>
                ...
                <div class="media-brief mv-10 hidden-xs hidden-sm">
                ...
                <div class="media-meta mt-5 mb-10 muted hidden-xs hidden-sm">
                    <span>
