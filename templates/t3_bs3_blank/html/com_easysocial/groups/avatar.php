...
<div class="es-profile-header-avatar es-flyout" data-group-avatar>
    <a href="<?php echo $group->getAvatarPhoto() ? 'javascript:void(0);' : $group->getPermalink();?>" class="es-avatar" <?php echo $group->getAvatarPhoto() ? 'data-es-photo="' . $group->getAvatarPhoto()->id . '"' : '';?>>
