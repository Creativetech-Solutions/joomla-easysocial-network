...
$notoolbar = array(" view-registration");
?>
<div id="fd" class="es es-main <?php echo $view . $task . $object . $layout . $suffix; ?> " data-es-structure>
	<?php echo $this->render( 'module' , 'es-general-top' ); ?>
	<?php //if( $view == ' view-dashboard' OR $view == ' view-profile'){ ?>
	<?php //echo $toolbar; ?>
	<?php //} ?>
