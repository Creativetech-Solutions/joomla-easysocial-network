...
$(function(){ // DOM ready
  ...
  $('#tags').on('click', 'span', function() {
    if(confirm("Remove "+ $(this).text() +"?")) { 
    	var g=$(this).text();
   	var k=document.getElementById('audiotags').value=document.getElementById('audiotags').value.replace(g+',','');
    	if(k==',')
...
function readURL(input) 
{
   ...
   {
     	 document.getElementById("audioname").innerHTML=input.files[0]['name'];
...
function maxsize(input) 
{
   if (input.files && input.files[0]) 
   {
     	 ...
     	 {
		alert("<?php echo JText::_('COM_COMMUNITY_AUDIO_FILE_SIZE_MUST_LESS_THEN_30MB'); ?>");
		max=1;
	 	return false;
	 }
	 else
...
<form action="<?php //echo JRoute::_($this->request_url) ?>" method="post" name="audioForm" id="audioForm" enctype="multipart/form-data">
    ...
    <div class="col50 traininglisting">
        ...
        <?php /*?><div class="audioportionleft" id="audioportionleft">
...
<?php echo JText::_( 'COM_COMMUNITY_FOR_YOUR_AUDIO_ART' ); ?></span> <input type="file" id="audio_image"  class="audio_image"  name="audio_image" accept="image/*" onChange="return profile_photo1(this);"/>
       -->
        </div><?php */?>
        ...
        <li class="autofile"> 
			<span class="uploadidvfile" id="up">
				<span id="audioname" class="dispaudioname"></span>

				<span id="uploadtextid">
					<?php echo JText::_( 'COM_COMMUNITY_CHOOSE_AN_AUDIO_FILE' ); ?> 
				</span>
			</span>        
			<input type="file" id="audio_file"  class="audio_file" name="audio_file" accept="audio/*" onchange="maxsize(this);readURL(this); "/>
		</li>
        
        <li><label><?php echo JText::_( 'COM_COMMUNITY_AUDIO_TITLE' ); ?></label>
        <input type="text" id="audio_title"  class="audio_title" name="title" />   
        </li>
        <li><label><?php echo JText::_( 'COM_COMMUNITY_GENER' ); ?></label>
         <!--<input type="text" id="audio_gener"  class="audio_gener" name="audio_gener" />   </li> -->
        <select id="audio_gener"  class="audio_gener" name="gener">
        ...
        <li><label><?php echo JText::_( 'COM_COMMUNITY_TAGES' ); ?></label>
        <div id="tags">
        	<input type="text" id="audio_tags"  class="audio_tags" name="tags" placeholder="Enter tags" />
        	<input type="hidden" id="audiotags" name="audiotags" value="">
        </div>
        </li>
        <li><label><?php echo JText::_( 'COM_COMMUNITY_PRIVECY_SETTING' ); ?></label>
        
        <div class="bottmddivpchek"> 
            <span><input type="radio" name="audio_privacy" class="privacy" checked="checked" value="10" /><b><?php echo JText::_( 'COM_COMMUNITY_PUBLIC' ); ?> </b><?php echo JText::_( 'COM_COMMUNITY_TRACHAPPEAR' ); ?></span>
            <span><input type="radio" name="audio_privacy"  class="audio_privacy" value="0"  /><b><?php echo JText::_( 'COM_COMMUNITY_PRIVATE' ); ?> </b><?php echo JText::_( 'COM_COMMUNITY_TRACH_VISIBLE' ); ?></span>
        </div>
        </li>
...
<div class="clr"></div>
  ...
  <input type="hidden" name="task" value="audio_save" />
   <input type="hidden" name="view" value="audio" />
   <input type="hidden" name="controller" value="audio">
...
function profile_photo1(aaa)
{
    ...
    else
    {
        ...
        jQuery('#audioportionleft').addClass('myextraclass')
...
<script>
		...
		var croppicHeaderOptions = {
				...
				cropUrl: url+'index.php?option=com_community&view=audios&task=img_crop_to_file',
		...
		var croppicContainerModalOptions = {
				...
				uploadUrl:url+'index.php?option=com_community&view=audios&task=img_save_to_file',
				cropUrl:url+'index.php?option=com_community&view=audios&task=img_crop_to_file',
				modal:true,
