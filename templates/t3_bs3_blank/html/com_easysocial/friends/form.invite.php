	...
	<div class="es-container">
		<div class="controls-group-wrap">
			...
			<div class="control-group">
				...
				<div class="controls">
					<?php echo $editor->display('message', JText::_('COM_EASYSOCIAL_FRIENDS_INVITE_MESSAGE_CONTENT'), '100%', '200', '10', '5', array('image', 'pagebreak', 'ninjazemanta', 'article', 'readmore'), null, 'com_easysocial'); ?>
				</div>
