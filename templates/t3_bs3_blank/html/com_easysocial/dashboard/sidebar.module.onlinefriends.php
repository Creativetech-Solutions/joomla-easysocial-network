                ...
                <?php foreach ($friendsData as $friend) {
                    ...
                    <li class="clearfix">
                        <div class="es-avatar-wrap pull-left">
                           ...
                           <?php echo $this->loadTemplate( 'site/utilities/user.online.state' , array( 'online' => $friend->isOnline() , 'size' => 'small' ) ); ?>

                        </div>
                        <div class="friendname pull-left"><?php echo $friend->name ?></div>
