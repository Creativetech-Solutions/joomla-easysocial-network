...
class AudiosModel extends EasySocialModel {
    ...
    public function getAudios($options = array()) {
        ...
        if ( ($sort) && ($input->get('clayout') != 'list')) {
            switch ($sort) {
                case 'popular':
                    $query[] = "order by a.hits desc";
                    break;
        ...
        if($input->get('clayout') == 'list'){
            switch($orderby){
                case 'date':
                    $query[] = "ORDER BY a.created ".$datedirection;
                    break;
                case 'title':
                    $query[] = "ORDER BY a.title ".$titledirection;
                    break;
                case 'plays':
                    $query[] = "ORDER BY a.hits ".$playsdirection;
                    break;
                case 'likes':
                    $query[] = "ORDER BY likes ".$likesdirection;
                    break;
            }
        }
