...
<div class="mod-es-search module-search<?php echo $suffix; ?>">
    <div class="mod-bd">
        <div class="es-widget searchbar">
            <form action="<?php echo JRoute::_('index.php'); ?>" method="post">

                <div id="sb-search-mobile" class="sb-search fd-navbar-search" data-mod-search data-showadvancedlink="<?php echo $params->get('showadvancedlink', 1); ?>">

                    <input type="text" name="q" class="sb-search-input form-control input-sm" autocomplete="off" data-nav-search-input placeholder="<?php echo JText::_('MOD_EASYSOCIAL_SEARCH_PHASE', true); ?>" />
