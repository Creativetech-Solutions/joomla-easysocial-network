...
class ATSAutocloseApp extends JApplicationCli
{
	...
	public function execute()
	{
		...
		if ($silent_age >= 1)
		{
			...
			$jUntil	 = $container->platform->getDate($until);

            /** @var \Akeeba\TicketSystem\Admin\Model\Tickets $ticketModel */
            $ticketModel = $container->factory->model('Tickets')->tmpInstance();
            ...
            foreach ($tickets as $ticket)
            {
				...
				\Akeeba\TicketSystem\Site\Model\Tickets::$noPermissionsCheck = 1;
				$ticket->save();
				\Akeeba\TicketSystem\Site\Model\Tickets::$noPermissionsCheck = 0;
            }
		}
