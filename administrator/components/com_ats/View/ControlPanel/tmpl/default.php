...
{
    $template->addCSS('admin://components/com_ats/assets/datatables/css/datatables.css', $container->mediaVersion);
...
$template->addCSS('media://com_ats/css/backend.css', $container->mediaVersion);
...
<?php if($this->needsMenuItem):?>
    <div class="alert alert-warning">
        <?php echo JText::_('COM_ATS_MISSING_CATEGORIES_MENU')?>
    </div>
<?php endif;?>
...
<?php if($this->needsdlid): ?>
    <div class="alert alert-success">
        <h3>
            <?php echo JText::_('COM_ATS_CPANEL_MSG_MUSTENTERDLID') ?>
        </h3>
        <p>
            <?php echo JText::sprintf('COM_ATS_LBL_CPANEL_NEEDSDLID','https://www.akeebabackup.com/instructions/1519-akeeba-ticket-system-download-id.html'); ?>
        </p>
		...
		<span>
			<?php echo JText::_('COM_ATS_CPANEL_MSG_PASTEDLID') ?>
		</span>
            <input type="text" name="dlid" placeholder="<?php echo JText::_('COM_ATS_CONFIG_DOWNLOADID_LABEL')?>" class="input-xlarge">
            <button type="submit" class="btn btn-success">
                <span class="icon icon-checkbox"></span>
                <?php echo JText::_('COM_ATS_CPANEL_MSG_APPLYDLID') ?>
            </button>
        </form>
    </div>
<?php endif; ?>
...
<script type="text/javascript">
    ...
    (function($) {
        $(document).ready(function()
        {
            ...
            var url = "index.php?option=com_ats&view=TicketStatistics&layout=latest&enabled=1&groupbydate=1&public=&status=&format=json";
            ...
            $.getJSON(url, {
                ...
                url = "index.php?option=com_ats&view=PostStatistics&layout=latest&enabled=1&groupbydate=1&format=json";
                $.getJSON(url, {
                    'limitstart' : 0,
                    'limit' : 0,
                    'created_on' : {
