...
class Updates extends Update
{
	...
	{
		$config['update_component'] = 'pkg_ats';
		$config['update_sitename']  = 'Akeeba Ticket System';

		if(defined('ATS_PRO') && ATS_PRO)
		{
			$config['update_site']      = 'http://cdn.akeebabackup.com/updates/atspro.xml';
		}
		else
		{
			$config['update_site']      = 'http://cdn.akeebabackup.com/updates/atscore.xml';
		}
...
ENDSUBJECT;
		...
		$email_body = <<<ENDBODY
This email IS NOT sent by the authors of Akeeba Ticket System. It is sent automatically
...
Your site has determined that there is an updated version of Akeeba Ticket System
