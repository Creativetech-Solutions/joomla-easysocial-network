...
class Text extends Base
{
	...
	public function getField($item, $cache, $userparams)
	{
		...
		$html = '<input type="' . $this->input_type . '" class="form-control span6" name="params[' . $item->slug . ']" id="' . $item->slug . '" value="' . htmlentities($current, ENT_COMPAT, 'UTF-8') . '" placeholder="' . $placeholder . '" />';
