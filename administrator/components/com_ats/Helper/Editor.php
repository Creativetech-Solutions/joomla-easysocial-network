...
JS
        ...
        {
            \JHtml::_('behavior.modal', 'a.ats-modal');
...
JS
            ...
            $html .= '<a class="ats-modal" style="display: none" id="atsCannedReplyDialog" href="' . $url . '" rel="{handler: \'iframe\', size: {x: 800, y: 500}}">Select</a>';
        ...
        if($bucket && ATS_PRO)
        {
            ...
            $html .= '<a class="ats-modal" style="display: none" id="atsBucketsDialog" href="' . $url . '" rel="{handler: \'iframe\', size: {x: 800, y: 500}}">Select</a>';
        }
...
JS
            ...
            $other_buttons .= '<span class="pull-left ats-canned-reply-button"><a class="ats-modal btn btn-small" id="atsCannedReplyDialog" href="' . $url . '" rel="{handler: \'iframe\', size: {x: 800, y: 500}}">'.
                '<i class="icon-book"></i> '.
        ...
        if($buckets && ATS_PRO)
        {
            ...
            $other_buttons .= '<span class="pull-left ats-canned-reply-button"><a class="ats-modal btn btn-small" id="atsBucketsDialog" href="' . $url . '" rel="{handler: \'iframe\', size: {x: 800, y: 500}}">'.
