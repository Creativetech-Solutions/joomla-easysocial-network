...
<!---------------------------------------- End Ordering Script ------------------------- category_detail ----------------->
...
<div id="editcell">
	...
	<thead>
		<tr>
			...
			<th class="hidden-phone"  width="10%">
				<?php echo JHTML::_('grid.sort', 'CATEGORY_NAME', 'cname', $this->lists['order_Dir'], $this->lists['order'] ); ?>				
			</th>
	...
	<?php
	$k = 0;
	// echo '<pre>'; print_r($this->category); exit;
