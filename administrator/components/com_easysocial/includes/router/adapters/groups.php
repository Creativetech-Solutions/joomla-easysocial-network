...
class SocialRouterGroups extends SocialRouterAdapter
{
	...
	public function parse(&$segments)
	{
		...
		if ($total > 3) {
			...
			// All group videos
			if ($total >= 5 && $segments[0] == $this->translate('videos_group') && $segments[3] == $this->translate('videos')
				&& $segments[4] == $this->translate('videos_group_layout_item')) {
				...
				array_unshift($segments, 'videos', 'group', $uid, $videoId);
