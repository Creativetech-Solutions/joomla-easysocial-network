...
class SocialThemes extends SocialTemplate
{
	...
	public function getCurrentTheme()
	{
		...
		// Retrieve user theme.
		$profileObj = FD::user()->getProfile();
		$params = $profileObj->getParams();
		$profileTheme = $params->get('theme');

		// If the profile type didn't assign to any theme, system will get the default theme.
		if (empty($profileTheme)) {
			$profileTheme = $config->get('theme.site');
		}
