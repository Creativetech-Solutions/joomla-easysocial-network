...
class Pkg_AtsInstallerScript
{
	...
	protected $extensionsToEnable = array(
		array('plugin', 'customfields', 1, 'ats'),
		array('plugin', 'gravatar', 1, 'ats'),
		array('plugin', 'postemail', 1, 'ats'),
		array('plugin', 'atscredits', 1, 'content'),
		array('plugin', 'ats', 1, 'finder'),
		array('plugin', 'ats', 1, 'search'),
		array('plugin', 'ats', 1, 'user'),
    );
