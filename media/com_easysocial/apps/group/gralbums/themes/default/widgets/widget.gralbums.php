...
<div class="es-widget">
	<div class="es-widget-head">
		<div class="pull-left widget-title">
			<?php echo JText::_('APP_GROUP_GRALBUMS_WIDGET_TITLE'); ?>
		</div>
		...
		<?php if ($albums) { ?>
			<a class="fd-small pull-right" href="<?php echo $link;?>"><?php echo JText::_('APP_GROUP_PHOTOS_WIDGET_VIEW_ALL_ALBUMS');?></a>
		<?php } ?>
	</div>
