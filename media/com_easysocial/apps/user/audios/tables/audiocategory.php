...
class AudiosTableAudioCategory extends SocialTable {
    ...
    public function __construct(& $db) {
        parent::__construct('#__social_audios_categories', 'id', $db);
    }
    ...
    public function getApp() {
        ...
        if (empty($app)) {
            $app = FD::table('app');
            $app->load(array('type' => SOCIAL_TYPE_APPS, 'group' => SOCIAL_APPS_GROUP_USER, 'element' => 'audios'));
        }
    ...
    public function delete($pk = null) {
        ...
        // Delete streams that are related to this audio.
        $stream = FD::stream();
        $stream->delete($this->id, 'audios');

        return $state;
    }

    /**
     * Shorthand to get the permalink of this audio.
     *
     * @author Jason Rey <jasonrey@stackideas.com>
     * @since  1.2
     * @access public
     * @param  boolean   $external True of the link should be external ready.
     * @return string              The permalink of the audio.
     */
