(function($){
	...
	.done(function($)
	{
		EasySocial.Controller(
			...
			function(self)
			{
				...
				return {
					...
					{
						self.items().implement( EasySocial.Controller.Dashboard.User.Apps.Audios.Item ,
							{
								"{parent}"	: self
							});
					},
		...
		EasySocial.Controller(
			'Dashboard.User.Apps.Audios.Item',
			{
				defaultOptions:
				{
							...
							bindings	:
							{
								...
								"{createButton} click" : function()
								{
									...
									.done(function( item )
									{
										...
										$( item ).implement( EasySocial.Controller.Dashboard.User.Apps.Audios.Item , { "{parent}" : self });
		...
		$( '[data-dashboard-app-audios]' ).implement( EasySocial.Controller.Dashboard.User.Apps.Audios );
