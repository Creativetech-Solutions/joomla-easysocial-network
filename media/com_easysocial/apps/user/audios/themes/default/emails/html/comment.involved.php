    ...
    <td style="text-align: center;padding: 40px 10px 0;">
        <div style="margin-bottom:15px;">
            <div style="font-family:Arial;font-size:32px;font-weight:normal;color:#333;display:block; margin: 4px 0">
                <?php echo JText::_( 'APP_USER_AUDIOS_EMAILS_COMMENT_INVOLVED_CONTENT_TITLE' ); ?>
            </div>
        </div>
    </td>
</tr>
...
<tr>
    <td style="text-align: center;font-size:12px;color:#888">
        ...
        <table width="540" cellspacing="0" cellpadding="0" border="0" align="center">
            <tr>
                <td>
                    ...
                    <p style="text-align:left;">
                        <?php echo JText::sprintf('APP_USER_AUDIOS_EMAILS_COMMENT_INVOLVED_CONTENT_BODY', $actor) ;?>
                    </p>
                </td>
            </tr>
        </table>
        ...
        <a style="
                ...
                " href="<?php echo $permalink;?>"><?php echo JText::_('APP_USER_AUDIOS_EMAILS_COMMENT_INVOLVED_CONTENT_VIEW');?></a>
