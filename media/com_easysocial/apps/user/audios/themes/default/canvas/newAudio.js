...
(function (document, window, index)
{
    ...
    var form = document.querySelector('#audio-form');
        var input = form.querySelector('input[name="audio_file"]'),
            ...
            droppedFiles = false,
            showFiles = function (audio_file)
            {
                step1.style.display = 'none';
                step2.style.display = 'block';
                label2.textContent = audio_file.name;
...
//                },
            checkfiletype = function (audio_file) {
                var audio_filename = audio_file.name.split('.').pop().toLowerCase();
