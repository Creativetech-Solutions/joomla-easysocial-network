...
/**
 * Audios application installer.
 *
 * @since	1.0
 * @author	Mark Lee <mark@stackideas.com>
 */
class SocialUserAppsAudiosInstaller implements SocialAppInstaller
{
	/**
	...
	public function success()
	{
		ob_start();
	?>
	<h6>Thank you for installing Audios!</h6>
	<p>
		Audios is an application that allows site users to create, share or store audios on the site. Once the application is installed, you will need to publish the application.
	</p>
