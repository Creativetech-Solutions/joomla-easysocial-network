...
$document->addStyleSheet(rtrim(JURI::root(), '/') . '/media/com_easysocial/apps/user/audios/assets/css/hap_modern3.css');
...
<!-- player code -->   
<div id="hap-wrapper-<?= $audio->id ?>" class="hap-player  <?php
...
?> ">
    ...
    <div class="hap-player-holder">
        ...
        <div class="hap-player-controls">
            <div class="hap-prev-seek hap-contr-btn"><i class="fa fa-backward hap-contr-btn-i hap-icon-color"></i></div>
            <div class="hap-playback-toggle hap-contr-btn"><i class="fa fa-play hap-contr-btn-i hap-icon-color"></i></div>
            <div class="hap-next-seek hap-contr-btn"><i class="fa fa-forward hap-contr-btn-i hap-icon-color"></i></div>
        </div>
