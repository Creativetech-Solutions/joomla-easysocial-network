...
<dialog>
    ...
    <bindings type="javascript">
        {
            ...
            "{saveJob} click" : function()
            {
                ...
                EasySocial.ajax('apps/user/projects/controllers/projects/editJob', {
    ...
    <title><?php echo JText::_('COM_EASYSOCIAL_PROJECT_DIALOG_EDIT_JOB_TITLE'); ?></title>
    <content>
        <p class="mt-5">
            <?php echo JText::_('COM_EASYSOCIAL_PROJECT_JOB_FORM_ADD_JOB_TITLE'); ?>
        </p>
        <p class="mt-5">
            <input type="text" value="<?php echo $job->title ?>" name="title" class="form-control input-sm" data-field-job-title>
        </p>
        <p class="mt-5">
        ...
        <div>
            <textarea data-field-job-description class="form-control input-sm" rows="5" name="job_description" ><?php echo $job->job_description ?></textarea>
        </div>
        ...
        <div class="mt-5">
            <p class="mt-5">
                <input type="radio" name="position" <?php echo ($job->position == 0) ? 'checked="checked"' : ''; ?> value="0" />
                <?php echo JText::_('COM_EASYSOCIAL_PROJECT_JOB_FORM_POSITION_VOLUNTEER'); ?>
            </p>
            <p class="mt-5">
                <input type="radio" name="position" <?php echo ($job->position == 1) ? 'checked="checked"' : ''; ?> value="1" />
