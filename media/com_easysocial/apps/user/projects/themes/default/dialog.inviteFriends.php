...
<dialog>
    ...
    <bindings type="javascript">
    {
        ...
        "{sendInvite} click" : function()
        {
            ...
            EasySocial.ajax('apps/user/projects/controllers/projects/inviteFriends', {
    ...
    <content>
        <p class="alert alert-danger" style="display: none;" data-error-message><?php echo JText::_('COM_EASYSOCIAL_PROJECT_DIALOG_INVITE_TO_PROJECT_ERROR_NO_USERS'); ?></p>
        <p class="mt-5">
            <?php echo JText::sprintf('COM_EASYSOCIAL_PROJECT_DIALOG_INVITE_TO_PROJECT_CONTENT', $project->getTitle());?>
        </p>
