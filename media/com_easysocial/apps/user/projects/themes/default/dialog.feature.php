...
$title = !$featured ? 'APP_PROJECTS_DIALOG_FEATURE_CONFIRMATION_TITLE' : 'APP_PROJECTS_DIALOG_UNFEATURE_CONFIRMATION_TITLE';
$content = !$featured ? 'APP_PROJECTS_DIALOG_FEATURE_CONFIRMATION_DESC' : 'APP_PROJECTS_DIALOG_UNFEATURE_CONFIRMATION_DESC';
...
<dialog>
	...
	<selectors type="json">
	{
		"{featuredButton}"	: "[data-feature-button]",
                "{project_id}"          : "[data-field-project-id]",
	...
	<content>
		<p><?php echo JText::_( $content ); ?></p>
                <input type="hidden" value="<?php echo $id; ?>" name="project_id" data-field-project-id>
