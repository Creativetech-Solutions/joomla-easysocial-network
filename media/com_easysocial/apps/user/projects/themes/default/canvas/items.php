...
<div class="es-snackbar">
    ...
    <span>
        <?php echo JText::_("COM_EASYSOCIAL_PROJECTS"); ?>
    </span>
    
    <a style="float: right;" href="<?= FRoute::apps(array('layout' => 'canvas', 'clayout' => 'all', 'id' => $app->getAlias(), 'uid' => $user->getAlias(), 'type' => SOCIAL_TYPE_USER)) ?>">See All</a>
</div>
        ...
        <?php foreach ($projects as $project) { ?>
            <div class="es-project-item" data-apps-projects-item data-id="<?php echo $project->id;?>"
                ...
                <div class="es-project-content">
                    <div class="es-project-thumbnail">
