...
final class bfAudit
{
    ...
    public function __construct($request)
    {
        ...
        if (property_exists($request, 'NOTENCRYPTED') && array_key_exists('pattern', $request->NOTENCRYPTED)) {
            ...
            $patterns = file_get_contents($url);
    ...
    private function deepscanAction()
    {
        ...
        try {
            ...
            if (!$queueCount && !$this->deepscancomplete) {
                ...
                $whitelist = file_get_contents($url);
                ...
                $hacklist = file_get_contents($url);
                ...
                $hacklistSQL = 'UPDATE bf_files SET queued = 0, suspectcontent = 1 WHERE currenthash IN (' . $hacklist . ')';
            ...
            if ($this->db->loadResult() == 0) {
                ...
                file_put_contents('tmp/tmp.pattern.lastmd5', md5_file('tmp/tmp.pattern'));
