...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <?php if (JString::strlen($this->params->get('additional_information')) > 0) { ?>
        ...
        <?php foreach ($files as $file) {
            $title = htmlentities(($file->getTitle()) ?: $file->getImage(), ENT_QUOTES, 'UTF-8');
            ?>
        <div class="row mt-10" id="js-cfgallery-item<?php echo $file->getId(); ?>">
            <div class="col-md-3"><img src='<?php echo $mediaUri .'/'. $file->getThumbnail(); ?>' alt="<?php echo $title; ?>"/></div>
            <div class="col-md-7"><?php echo $title; ?></div>
            <div class="col-md-2">
                <a class="btn btn-danger js-cfgallery-btn-remove" data-item-id="<?php echo (int)$file->getId(); ?>" href="<?php echo JRoute::_('index.php?option=com_magicgallery&task=item.remove&format=raw');?>">
        ...
        <div class="row mt-10" style="display: none;" id="js-cfgallery-row-template">
            ...
            <div class="col-md-2">
                <a class="btn btn-danger" id='js-cfgallery-rt-remove' href="<?php echo JRoute::_('index.php?option=com_magicgallery&task=item.remove&format=raw');?>">
                    <span class="fa fa-trash"></span>
                    <?php echo JText::_('PLG_CROWDFUNDING_GALLERY_DELETE');?>
                </a>
            </div>
